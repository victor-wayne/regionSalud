...
@section('content')
    ...
    <div class="container text-center">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="doctor-block">
                    <iframe width="530" height="450" src="https://www.youtube.com/embed/{{ $hospitales->video }}" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                </div>
            </div>
            <div class="col-md-6">
                <div class="doctor-block">

                    <h3>{{ $hospitales->name }}</h3><hr>

                    <div class="doctor-info panel">
                        <br>
                        <p><strong>{{ $hospitales->description }}</strong></p>
                        ...
                        @foreach($var_address_secc as $address_sec)
                            ...
                            @foreach($var_horarios as $var_horarios)
                                ...
                                @foreach($var_ciudades as $var_ciudad)
                                    ...
                                    <span class="fa fa-envelope" style="font-size:15px"></span><strong> E-mail:</strong><p> {{ $hospitales->email }}</p>
                                    <span class="fa fa-laptop" style="font-size:20px"></span><strong> Sitio Web</strong>
                                    <p><strong> <a href="{{ $hospitales->web }}">{{ $hospitales->web }}</a></strong></p>
                    </div>

                    <h4>Redes Sociales</h4>


                    <a href="{{ $hospitales->face }}" class="fa fa-facebook-square" style="font-size:36px"></a>
                    <a href="{{ $hospitales->twi }}" class="fa fa-twitter" style="font-size:36px"></a>
                    <a href="{{ $hospitales->insta }}" class="fa fa-instagram" style="font-size:36px"></a>
        ...
        <p>
            <a class="btn btn-primary" href="{{ route('hospitales-show') }}">
